            ...
            <div className="lg:max-w-[750px] w-full">
              ...
              <div>
                <span className="flex items-center gap-3 mb-4">
                  <a href="#" className="ease-out duration-200 hover:text-orange">
                    Mar 27, 2022
                  </a>
                ...
                <div className="flex flex-wrap items-center justify-between gap-10 mt-10">
                  <div className="flex flex-wrap items-center gap-5">
                    ...
                    <ul className="flex flex-wrap items-center gap-3.5">
                      <li>
                        <a
                          className="inline-flex hover:text-white border border-gray-3 bg-white py-2 px-4 rounded-md ease-out duration-200 hover:bg-orange-600 hover:border-blue"
                          href="#"
                        >
                          Desktop
                        </a>
              ...
              <div className="shadow-1 bg-white rounded-xl mt-7.5">
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex flex-col gap-3">
                    <button className="group flex items-center justify-between ease-out duration-200 text-dark hover:text-orange">
                      Desktop
                      <span className="inline-flex rounded-[30px] bg-gray-2 text-custom-xs px-1.5 ease-out duration-200 group-hover:text-white group-hover:bg-orange-600">
                        12
                      </span>
                    </button>
              ...
              <div className="shadow-1 bg-white rounded-xl mt-7.5">
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex flex-wrap gap-3.5">
                    <a
                      className="inline-flex hover:text-white border border-gray-3 py-2 px-4 rounded-md ease-out duration-200 hover:bg-orange-600 hover:border-blue"
                      href="#"
                    >
                      Desktop
                    </a>
