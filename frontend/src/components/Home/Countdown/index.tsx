      ...
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        <div className="relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15">
          <div className="max-w-[422px] w-full">
            ...
            <p>NutriMax Multivitamin helps support immune health, mental focus, and daily energy. Trusted by doctors, loved by users.
</p>
            ...
            <a
              href="#"
              className="inline-flex font-medium text-custom-sm text-white bg-orange py-3 px-9.5 rounded-md ease-out duration-200 hover:bg-orange-dark active:bg-orange-600 mt-7.5"
            >
              Get Your Discount
            </a>
          </div>
          ...
          />
          <Image
            src="/images/countdown/countdown-01.webp"
            alt="product"
