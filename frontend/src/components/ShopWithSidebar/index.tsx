                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="bg-white shadow-1 rounded-lg py-4 px-5">
                    <div className="flex items-center justify-between">
                      <p>Filters:</p>
                      <button className="text-orange">Clean All</button>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      className={`${
                        productStyle === "grid"
                          ? "bg-orange-600 border-blue text-white"
                          : "text-dark bg-gray-1 border-gray-3"
                      } flex items-center justify-center w-10.5 h-9 rounded-[5px] border ease-out duration-200 hover:bg-orange-600 hover:border-blue hover:text-white`}
                    >
                      <svg
                        className="fill-current"
                        width="18"
                ...
                <div className="bg-white shadow-1 rounded-md p-2">
                  <ul className="flex items-center">
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-1.5 px-3.5 duration-200 rounded-[3px] bg-orange text-white hover:text-white hover:bg-orange-dark active:bg-orange-600"
                      >
                        1
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-1.5 px-3.5 duration-200 rounded-[3px] hover:text-white hover:bg-orange-dark active:bg-orange-600"
                      >
                        2
                      </a>
                    </li>
                    ...
                    <li>
                      <button
                        ...
                        aria-label="button for pagination left"
                        type="button"
                        className="flex items-center justify-center w-8 h-9 ease-out duration-200 rounded-[3px] hover:text-white hover:bg-orange-600 disabled:text-gray-4"
                      >
                        <svg
                          className="fill-current"
                          width="18"
