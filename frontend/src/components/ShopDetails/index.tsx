              ...
              <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
                  ...
                  <div className="lg:min-h-[512px] rounded-lg shadow-1 bg-gray-2 p-4 sm:p-7.5 relative flex items-center justify-center">
                    <div>
                      {/* <button
                        ...
                        className="gallery__Image w-11 h-11 rounded-[5px] bg-gray-1 shadow-1 flex items-center justify-center ease-out duration-200 text-dark hover:text-orange absolute top-4 lg:top-6 right-4 lg:right-6 z-50"
                      >
                        <svg
                ...
                <div className="max-w-[539px] w-full">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="inline-flex font-medium text-custom-sm text-white bg-orange-600 rounded py-0.5 px-2.5">
                      30% OFF
                    </div>
                  </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4.5">
                      <div className="flex items-center rounded-md border border-gray-3">
                        <button
                          ...
                          className="flex items-center justify-center w-12 h-12 ease-out duration-200 hover:text-orange"
                          onClick={() =>
                      ...
                      <a
                        href="#"
                        className="inline-flex font-medium text-white bg-orange py-3 px-7 rounded-md ease-out duration-200 hover:bg-orange-dark active:bg-orange-600"
                      >
                        Purchase Now
                      </a>
              ...
              <div className="flex flex-wrap items-center bg-white rounded-[10px] shadow-1 gap-5 xl:gap-12.5 py-4.5 px-4 sm:px-6">
                {tabs.map((item, key) => (
                  <button
                    ...
                    className={`font-medium lg:text-lg ease-out duration-200 hover:text-orange relative before:h-0.5 before:bg-orange-600 before:absolute before:left-0 before:bottom-0 before:ease-out before:duration-200 hover:before:w-full ${
                      activeTab === item.id
