          ...
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <div>
              <form>
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center font-medium text-white bg-orange py-3 px-6 rounded-lg ease-out duration-200 hover:bg-orange-dark active:bg-orange-600 mt-7.5"
                >
                  Sign in to account
                </button>
                ...
                <p className="text-center mt-6">
                  ...
                  <Link
                    href="/signup"
                    className="text-dark ease-out duration-200 hover:text-orange pl-2"
                  >
                    Sign Up Now!
                  </Link>
                </p>
