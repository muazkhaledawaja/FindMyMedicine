...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Heart Medications", value: "1" },
    { label: "Diabetes Medications", value: "2" },
    { label: "Antibiotics", value: "3" },
    { label: "Pain Relievers", value: "4" },
    { label: "Supplements", value: "5" },
    { label: "Allergy Medications", value: "6" },
    { label: "Digestive Medications", value: "7" },
    { label: "Cold & Flu", value: "8" },
  ];
              ...
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-orange-600 w-4.5 h-4.5 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>
                ...
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className="group relative before:w-0 before:h-[3px] before:bg-orange-600 before:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full "
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-orange text-custom-sm font-medium text-dark flex ${
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                <li className="py-4">
                  <a
                    href="#"
                    className="flex items-center gap-1.5 font-medium text-custom-sm text-dark hover:text-orange"
                  >
                    <svg
                      className="fill-current"
                      width="16"
