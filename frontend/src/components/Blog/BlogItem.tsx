    ...
    <div className="shadow-1 bg-white rounded-xl px-4 sm:px-5 pt-5 pb-4">
      ...
      <div className="mt-5.5">
        <span className="flex items-center gap-3 mb-2.5">
          <a
            href="#"
            className="text-custom-sm ease-out duration-200 hover:text-orange"
          >
            {blog.date}
          </a>
        ...
        <h2 className="font-medium text-dark text-lg sm:text-xl ease-out duration-200 mb-4 hover:text-orange">
          <Link href="/blogs/blog-details">{blog.title}</Link>
        </h2>

        <Link
          href="/blogs/blog-details"
          className="text-custom-sm inline-flex items-center gap-2 py-2 ease-out duration-200 hover:text-orange"
        >
          Read More
          <svg
