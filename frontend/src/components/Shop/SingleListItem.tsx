...
const SingleListItem = ({ item }: { item: Product }) => {
  ...
  const handleAddToCart = () => {
    ...
    showSnackbar(`${item.title} added to cart!`, 'success');
  };
  ...
  const handleItemToWishList = () => {
    ...
    showSnackbar(`${item.title} added to WishList!`, 'success');
  };
    ...
    <div className="group rounded-lg bg-white shadow-1">
      <div className="flex">
        <div className="shadow-list relative overflow-hidden flex items-center justify-center max-w-[270px] w-full sm:min-h-[270px] p-4">
          ...
          <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
            <button
              ...
              className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-orange active:text-orange-600"
            >
              <svg
            ...
            <button
              ...
              className="inline-flex font-medium text-custom-sm py-[7px] px-5 rounded-[5px] bg-orange text-white ease-out duration-200 hover:bg-orange-dark active:bg-orange-600"
            >
              Add to cart
            </button>
        ...
        <div className="w-full flex flex-col gap-5 sm:flex-row sm:items-center justify-center sm:justify-between py-5 px-4 sm:px-7.5 lg:pl-11 lg:pr-12">
          <div>
            <h3 className="font-medium text-dark ease-out duration-200 hover:text-orange mb-1.5">
