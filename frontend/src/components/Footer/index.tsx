        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className="flex ease-out duration-200 hover:text-orange"
              >
                <svg
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <Link href="/profile" className="ease-out duration-200 hover:text-orange">
                  My Account
                </Link>
              </li>
              <li>
                <Link href='/signin' className="ease-out duration-200 hover:text-orange">
                  Login / Register
                </Link>
              </li>
              <li>
                <Link href='/cart' className="ease-out duration-200 hover:text-orange">
                  Cart
                </Link>
              </li>
              <li>
                <Link href='/wishlist' className="ease-out duration-200 hover:text-orange">
                  Wishlist
                </Link>
              </li>
              <li>
                <Link href='/shop-with-sidebar' className="ease-out duration-200 hover:text-orange">
                  Shop
                </Link>
              </li>
            </ul>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <a className="ease-out duration-200 hover:text-orange">
                  Privacy Policy
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <p className="lg:text-right text-custom-sm mb-4">
              Save ₪100 With App & New User only
            </p>

            <ul className="flex flex-col lg:items-end gap-3">
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-7.5 text-white rounded-md bg-orange-dark ease-out duration-200 hover:bg-opacity-95"
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-orange-600 ease-out duration-200 hover:bg-opacity-95"
          ...
          <div className="flex gap-5 flex-wrap items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-6">
                <a aria-label="payment system with visa card">
                  <Image
                ...
                <a aria-label="payment system with paypal">
                  <Image
                ...
                <a aria-label="payment system with master card">
                  <Image
                ...
                <a aria-label="payment system with apple pay">
                  <Image
                ...
                <a aria-label="payment system with google pay">
                  <Image
